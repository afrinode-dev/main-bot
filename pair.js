...
const config = {
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg',
        MENU: 'https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg',
        OWNER: 'https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg',
        SONG: 'https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg',
        VIDEO: 'https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg'
    }
};
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = '*𝚃𝙾𝙶𝙴-𝙼𝙳-𝚅𝟻 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳*';
                    const content = `*𝚃𝙾𝙶𝙴-𝙼𝙳 𝚅𝟻 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃*\n` +                                   `ʙᴏᴛ ᴏᴡɴᴇʀ :- *𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :- 𝚃𝙾𝙶𝙴-𝙼𝙳 𝚅𝟻 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*`;
...
case 'menu': {
    ...
    const title = 'ᴍɪɴɪ ᴍᴇɴᴜ*';

const text = 
`┏━━━━━━━━━━━━━━━━━━┓
┃       『 ꜱᴛᴀᴛᴜꜱ 』       
┗━━━━━━━━━━━━━━━━━━┛
   ⦁ *ʙᴏᴛ ɴᴀᴍᴇ*: 𝚃𝙾𝙶𝙴-𝙼𝙳 𝚅𝟻 𝙼𝙸𝙽𝙸
   ⦁ *ʙᴏᴛ ᴏᴡɴᴇʀ*: 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸
   ⦁ *ᴠᴇʀꜱɪᴏɴ*: ν5
   ⦁ *ᴘʟᴀᴛꜰᴏᴇᴍ*: ʀᴇɴᴅᴇʀ
...
//=======================================
                ...
                case 'owner': {
                    const vcard = 'BEGIN:VCARD\n'
                        ...
                        + 'FN:TOGE INUMAKI\n'
                        + 'ORG:TOGE INUMAKI\n'
                        + 'TEL;type=CELL;type=VOICE;waid=24102178283:+24102178283\n'
                        + 'EMAIL:togeoff2@gmail.com\n'
                        + 'END:VCARD';
    ...
    await socket.sendMessage(sender, {
        image: { url: "https://i.postimg.cc/QCvFcGXY/86701-F52-1-E26-4335-9-AF0-E48-C580337-EC.jpg" },
        caption: formatMessage(title, content, footer)
    });
    break;
                }
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        '𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸'}`);
                }
            }
        });
    } catch (error) {
